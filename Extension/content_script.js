...
PatternMatcherClass.prototype = {
  ...
  longestMatch: function (e) {
    let n = null,
      t = 0;
    for (let r of this._words) {
      let i = r.length;
      i < t || (regex = RegExp("\\b" + r + "\\b", "i"), regex.test(e) && (n = r, t = i))
    }
  ...
  searchReverse: function (e) {
    ...
    for (let t = this._words.length - 1; t >= 0; --t) {
      let r = this._words[t];
      if (regex = RegExp("\\b" + r + "\\b", "i"), regex.test(e)) {
        n = r;
        break
      }
    }
...
var ValueSpecifier = function (e, n, t, r, i) {
  this.property = e, this.component = n, this.label = t, this.category = r, this.parentProperty = i
},
  MapEntry = function (e, n, t) {
    this.keyLength = e, this.key = n, this.valueSpecifier = t
  },
  Map = function (e) {
  ...
  FormMetadataJSControllerObject = function () {
    this.mapOfKeywordsIndicatingLoginFormTypeToScoreForMatching = {
      ...
      reset: 1,
      "再設定": 1
    }, this.keywordsIndicatingNonAutoFillableFormType = ["import"], this.regularExpressionsForForgotPasswordLink = ["^forgot.*password"], this.regularExpressionsForForgotEmailAffordance = ["^forgot.*email"], this.shouldShowAdditionalUI = !0, this.nonUsernameFieldLabelPatternMatchers = function nonUsernameFieldLabelPatternMatchers() {
...
function legacyPlaceholderInfoForInputElement(e) {
  ...
  var n = e.value.trim();
  if (!n) return null;
  for (var t = !1, r = !0, i = e.attributes, a = i.length, o = 0; o < a; ++o) {
    var l = i[o];
    if (n === l.value.trim() && (t = !0, "value" !== l.name.toLowerCase())) {
      r = !1;
      break
    }
  }
...
function sharedPrefixLength(e, n) {
  for (var t = 0, r = 0, i = e.length; r < i && e[r] === n[r]; ++r) t++;
  return t
}

function rowContainingLabelAboveRow(e) {
  for (var n = e.getBoundingClientRect(), t = e.previousElementSibling; t instanceof HTMLTableRowElement; t = t.previousElementSibling) {
    if (t.querySelector("input, select, textarea")) return null;
    var r = t.getBoundingClientRect();
    if (n.top - r.bottom > n.height / 2) return null;
...
function cellVisuallyAbove(e) {
  ...
  var t = rowContainingLabelAboveRow(n);
  if (!t) return null;
  for (var r = e.getBoundingClientRect(), i = t.children, a = i.length, o = null, l = 0, s = 0; s < a; ++s) {
    var p = i[s],
      c = p.getBoundingClientRect(),
      u = Math.min(c.right, r.right) - Math.max(c.left, r.left);
    (!o || u > l) && (l = u, o = p)
  }
  return o
}
...
function isSelectInDefaultState(e) {
  for (var n = e.options, t = n.length, r = 0; r < t; ++r) {
    var i = n[r];
...
function selectElementOptionsSequenceAnalysis(e, n) {
  for (var t = e.options, r = t.length, i = 0, a = -1, o = -1, l = 0, s = 0; s < r; ++s) {
    var p = t[s],
      c = parseInt(p[n]);
...
function isElementPositionedToBeEffectivelyInvisible(e) {
  for (var n = !1, t = e; t; t = t.parentElement)
    if ("fixed" === getComputedStyle(t).position) {
      n = !0;
      break
    }
  var r, i, a, o = e.getBoundingClientRect();
  if (n) r = o, i = window.innerWidth, a = window.innerHeight;
  else {
  ...
  return r.top >= a || r.right <= 0 || r.bottom <= 0 || r.left >= i
}
...
function autocompleteTokens(e) {
  ...
  let t = [];
  for (const r of n) e.hasAttribute(r) && t.push(e.getAttribute(r).trim().toLowerCase());
  if (!t.length) return null;
  let r = t.join(" ").split(/\s+/).filter((function (e) {
...
function controlAppearsToBePartOfPhotoTaggingInterface(e) {
  ...
  for (var t = e.parentElement; t; t = t.parentElement)
    if (n.test(t.className)) return !0;
  return !1
}

function levenshteinDistance(e, n) {
  for (var t = e.length, r = n.length, i = new Array(t + 1), a = 0; a < t + 1; ++a) i[a] = new Array(r + 1), i[a][0] = a;
...
function stringSimilarity(e, n) {
  var t = Math.max(e.length, n.length);
  return t ? (t - levenshteinDistance(e, n)) / t : 0
}

function articleTitleAndSiteNameFromTitleString(e, n) {
  const t = [" - ", " – ", " — ", ": ", " | ", " » "],
    r = t.length;
  for (var i, a, o = e.replace(/^(www|m|secure)\./, ""), l = o.replace(/\.(com|info|net|org|edu|gov)$/, "").toLowerCase(), s = 0; s < r; ++s) {
    var p = n.split(t[s]);
    if (2 === p.length) {
      var c = p[0].trim(),
        u = p[1].trim(),
...
function queryElementBySelector(e, n) {
  return window.collectMatchingElementsInFlatTree ? window.collectMatchingElementsInFlatTree(e, n) : e.querySelectorAll(n)
}
...
function siblingsIncludingSelfForElement(e) {
  ...
  let r = [],
    i = t;
  for (; i;) r.push(i), i = i.nextElementSibling;
  return r
}
console.autofillDebugLog = function (e, ...n) {
  ...
  return e._isVisible = -visibilityCacheGeneration, "none" !== t.display && "visible" === t.visibility && (!(n.offsetWidth < 2) && (!(n.offsetHeight < 2) && (e._isVisible = visibilityCacheGeneration, !0)))
}, Object.defineProperty(Array.prototype, "joinFirstItems", {
  value: function (e, n) {
    n > this.length && (n = this.length);
    for (var t = "", r = 0; r < n; ++r) r > 0 && (t += e), t += this[r];
    return t
  }
  ...
  var n = [{
    ...
    p = [
      ...
      var n = e[0],
        t = e[1];
      if (n[0].x >= t[0].x && n[0].x < t[1].x || t[0].x >= n[0].x && t[0].x < n[1].x) return Math.abs(n[0].y - t[0].y);
      if (n[0].y >= t[0].y && n[0].y < t[1].y || t[0].y >= n[0].y && t[0].y < n[1].y) return Math.abs(n[0].x - t[0].x);

      function distanceBetweenTwoPointsSquared(e, n) {
        return Math.pow(e.x - n.x, 2) + Math.pow(e.y - n.y, 2)
      }
      return Math.sqrt(Math.min(distanceBetweenTwoPointsSquared(n[0], t[1]), distanceBetweenTwoPointsSquared(n[1], t[0])))
    }));
  ...
  return n && n.host ? n.host : null
}, HTMLElement.prototype.allAncestorsAndSelfIncludingShadowDOMHosts = function () {
  let e = [],
    n = this;
  for (; n;) e.push(n), n = n.parentElementIncludingShadowDOMHost();
  return e
  ...
  for (let n = 0, t = this; n <= 2 && t; ++n, t = t.parentElement) {
  ...
  for (var e = this.elements, n = e.length, t = 0; t < n; ++t)
  ...
  var t = e.length;
  this._formElement = e[0].form, this._backingElement = this._formElement, !n && this._backingElement || (this._backingElement = 1 === t ? e[0] : e[0].closestCommonAncestor(e[t - 1])), this._formElement || (this._formElement = this._backingElement);
  for (var r = 0; r < t; r++) e[r]._logicalForm = this, r + 1 < t && (e[r]._nextControlInLogicalForm = e[r + 1]), r > 0 && (e[r]._previousControlInLogicalForm = e[r - 1]);
  ...
  get elements() {
    ...
    let n = queryElementBySelector(document.documentElement, `*[name="${e}"]`);
    ...
    if (t) {
      ...
      hasOwnProperties(t) || delete n._annotations
  ...
  this._forms = [], this._formMetadata = [], this._elementsWithGeneratedPasswords = [], this._generatedPasswords = [], this._labels = queryElementBySelector(document, "label"), this._controlUniqueIDToControlMap = [], this._mapOfFormTypeToExtraScoreProducer = function () {
    ...
    t.type = n;
    return t.value = "a", e[n] = "" === t.value ? DateTimeInputTypeFormats[n] : "", e
  }), {})
  ...
  _searchForLabelsAboveCell: function (e, n) {
    ...
    var r = cellVisuallyAbove(n);
    if (!r) return null;
    for (var i = 0, a = r.firstChild; a; a = a.traverseNextNode(r))
  ...
  _collectStringFromNodeForPageScan: function (e, n, t) {
    var r = e.nodeValue,
      i = r.length;
    return t + i > 600 && (r = r.substr(-(500 - t)), i = 500 - t), (r = r.trim()).length && n.push(r), t
  },
    ...
    for (var l = e.traversePreviousNode(shouldStopScan); l && i < 500; l = l.traversePreviousNode(shouldStopScan)) {
      ...
      if (this._isRenderedFormControl(l)) {
        ...
        if ("td" !== s || t) {
          ...
          } else l.nodeType == Node.TEXT_NODE && l.isVisible() && (i += this._collectStringFromNodeForPageScan(l, r, i))
        } else t = l
      }
    }
    return [r, t]
  },
  _matchFromPageScanBeforeElement: function (e, n, t) {
    var r = this._pageScanContext ? this._pageScanContext.backwardScanCache : null,
      i = this._pageScanDataForElementWithCacheAndDataProducer(n, r, this._dataForComputingMatchFromPageScanBeforeElement.bind(this), t),
      a = i[0],
  ...
  _isElementFollowedByForgotEmailAffordance: function (e) {
    return this._forgotEmailRegularExpressions || (this._forgotEmailRegularExpressions = FormMetadataJSController.regularExpressionsForForgotEmailAffordance), this._isElementFollowedByAffordanceMatchingRegularExpresions(e, this._forgotEmailRegularExpressions)
  },
  _isElementFollowedByForgotPasswordAffordance: function (e) {
    return this._forgotPasswordRegularExpressions || (this._forgotPasswordRegularExpressions = FormMetadataJSController.regularExpressionsForForgotPasswordLink), this._isElementFollowedByAffordanceMatchingRegularExpresions(e, this._forgotPasswordRegularExpressions)
  },
  _isElementFollowedByAffordanceMatchingRegularExpresions: function (e, n) {
    let t = this._dataForComputingMatchFromPageScanAfterElement(e, "A");
    if (!t.length) {
      const n = e.traverseNextNode();
      if (n) {
        let e = n;
        n instanceof Node && (e = n.parentElement);
        const r = e.querySelector("a");
        r && (t = [r.innerText])
      }
    }
    if (!t.length) {
      let n = e._nextControlInLogicalForm;
      n && "button" === n.type && (t = [n.innerText])
    }
    for (let e of n) {
      let n = new RegExp(e);
      for (let e of t)
        if (n.test(e.toLowerCase())) return !0
    }
    return !1
  },
  _dataForComputingMatchFromPageScanAfterElement: function (e, n, t) {
    var r = [],
      i = 0,
      a = this._logicalFormForControl(e).formElement,
      o = a && a.isVisible();
    ...
    for (var s = e.traverseNextNode(); s && i < 500; s = s.traverseNextNode()) {
      ...
      if (this._isRenderedFormControl(s)) {
        ...
        if (s.nodeType == Node.TEXT_NODE && s.isVisible()) {
          ...
          if (i += this._collectStringFromNodeForPageScan(s, r, i), l) break
        }
      }
    }
    return r
  },
  _matchFromPageScanAfterElement: function (e, n, t) {
    var r = this._pageScanContext ? this._pageScanContext.forwardScanCache : null,
      i = this._pageScanDataForElementWithCacheAndDataProducer(n, r, this._dataForComputingMatchFromPageScanAfterElement.bind(this), t);
    return this._matchFromPatternMatcherAndStringsFromPageScan(e, i)
  },
  _pageScanDataForElementWithCacheAndDataProducer: function (e, n, t, r) {
    if (!n) return t(e, r);
  ...
  _matchFromPatternMatcherAndStringsFromPageScan: function (e, n) {
    for (var t = n.length, r = 0, i = 0; i < t; ++i) {
      var a = n[i];
      r += a.length;
  ...
  _createLogicalFormsForControls: function (e) {
    ...
    })), t = e.length, r = 0, i = 1, a = n[0].isZeroRect() ? null : n[0], o = 1; o < t; ++o) {
      if (!(d = n[o]).isZeroRect()) {
        if (a) {
    ...
    var s = r / i,
      p = [];
    for (o = 0; o < t; ++o) {
      for (var c = [e[o]], u = !1, f = (a = n[o].isZeroRect() ? null : n[o], o + 1); f < t; ++f) {
        var d, m = e[f];
        if (!(d = n[f]).isZeroRect()) {
          if (u) {
  ...
  _formLooksLikeAspnetForm: function (e) {
    ...
    for (var t = queryElementBySelector(e, "input"), r = 0, i = t.length; r < i; ++r) {
      var a = t[r],
        o = a.getAttribute("id"),
    ...
    for (var s = queryElementBySelector(document, "script"), p = s.length, c = 0; c < p; ++c) {
  ...
  _visibleInputAndSelectElementsInForm: function (e) {
    let n = queryElementBySelector(e, "input:not([type='hidden']), select"),
      t = [];
  ...
  _elementsActingAsButtonsInForm: function (e) {
    let n = Array.prototype.slice.call(queryElementBySelector(e, "input[type='submit'], input[type='image']")),
      t = queryElementBySelector(e, "a");
    for (var r = 0, i = t.length; r < i; ++r) {
      let e = t[r];
      this._anchorLooksLikeSubmitButton(e) && e.isVisible() && n.push(e)
    }
    return n
  },
  _logicalFormsForAspnetForm: function (e) {
    for (var n = this._visibleInputAndSelectElementsInForm(e), t = n.length, r = this._elementsActingAsButtonsInForm(e), i = r.length, a = 0; a < i; ++a) {
      (l = r[a]).getAttribute("id") && (l._aspNetIDComponents = l.getAttribute("id").split("_"))
    }
    r.sort((function (e, n) {
      var t = e._aspNetIDComponents || [];
      return (n._aspNetIDComponents || []).length - t.length
    }));
    var o = [];
    ...
    function groupElementsIntoLogicalFormsBasedOnTableLayout(e) {
      ...
      if (n <= 1) o.push(new LogicalForm(e, ForceNonFormElementAsLogicalBackingElement.Yes));
        ...
        var t = n - 1,
          r = e[t];
        if (e[0].closestCommonAncestor(r) instanceof HTMLTableRowElement) {
          for (var i = 0; i < t; ++i) {
            if (!(e[i].closestCommonAncestor(r) instanceof HTMLTableRowElement)) return groupElementsIntoLogicalFormsBasedOnTableLayout(e.slice(0, i)), void groupElementsIntoLogicalFormsBasedOnTableLayout(e.slice(i))
          }
    ...
    for (a = 0; a < i; ++a) {
      var l, s = (l = r[a])._aspNetIDComponents;
      if (s) {
        var p = s.length;
        if (!(p < 2)) {
          for (var c = s.joinFirstItems("_", p - 1) + "_", u = [], f = t - 1; f >= 0; --f) {
            var d = n[f],
              m = d.getAttribute("id");
            m && (m.startsWith(c) && (u.push(d), n.splice(f, 1)))
          }
          if (u.length && groupElementsIntoLogicalFormsBasedOnTableLayout(u.reverse()), !(t = n.length)) break
        }
      }
    }
    return t && groupElementsIntoLogicalFormsBasedOnTableLayout(n), o
  },
  _logicalFormsInPage: function (e, n) {
    var t = [],
      r = {};
    let i = queryElementBySelector(document, "form");
    for (var a = 0, o = i.length, l = 0; l < o; ++l) {
      var s = i[l];
      if (s.elements.length) {
        ...
        this._formLooksLikeAspnetForm(s) ? t = t.concat(this._logicalFormsForAspnetForm(s)) : t.push(new LogicalForm(s.elements))
      }
    }
    let u = [],
      f = queryElementBySelector(document, "input, select, textarea, button"),
      d = f.length;
    for (let e = 0; e < d; ++e) {
      let n = f[e];
      if (n.form) {
        if (!u.length) continue;
        t = t.concat(this._createLogicalFormsForControls(u)), u = []
      } else (this._isRenderedFormControl(n) || autocompleteTokens(n)) && u.push(n)
    }
    return u.length && (t = t.concat(this._createLogicalFormsForControls(u))), t
  },
  ...
  _matchPatternAgainstElement: function (e, n, t) {
    this._logicalFormForControl(t);
    var r = t._previousControlInLogicalForm,
      i = t._nextControlInLogicalForm;

    function attributeValueWithoutPrefixSharedWithSiblingElement(e, n) {
      if (!e) return null;
      var r = t[n],
        i = sharedPrefixLength(r, e[n]);
      return i ? r.substr(i) : null
    }
    const a = ["name", "id"],
      o = a.length;
    for (var l = new Array(o), s = new Array(o), p = 0; p < o; ++p) {
      var c = a[p];
      l[p] = attributeValueWithoutPrefixSharedWithSiblingElement(r, c), s[p] = attributeValueWithoutPrefixSharedWithSiblingElement(i, c)
    }
    var u = "select" === this._getTagName(t).toLowerCase(),
      f = u ? defaultOptionForSelectElement(t) : null;
    const d = n.length;
    for (var m = 0; m < d; ++m) {
      var v, y = n[m];
      for (p = 0; p < o && !(v = this._matchPatternAgainstString(y, l[p])) && !(v = this._matchPatternAgainstString(y, s[p])) && !(v = this._matchPatternAgainstString(y, t[a[p]])); ++p);
      if (!v && u && f) {
        var w = f.text;
        if (/^-.+-$/.test(w)) v = this._matchPatternAgainstString(y, w);
        else if (!f.value.length && w.length) {
          for (var E = t.options, h = E.length, M = !0, S = 0; S < h; ++S) {
            var g = E[S];
          ...
          M && (v = this._matchPatternAgainstString(y, w))
        }
      }
      v && e.push({
        FoundByPageScan: !1,
  ...
  _labelsForElement: function (e) {
    ...
    if (n && n.length) {
      ...
      for (var t = 0; t < r.length; t++) {
        let n = queryElementBySelector(document, "#" + r[t]),
          i = n.length ? n[0] : null;
        i && e._cachedLabels.push(i)
      }
    }
    ...
    if (r) {
      ...
      for (let t of this._labels) {
        n === t.closest("form") && t.getAttribute("for") === r && e._cachedLabels.push(t)
      }
    }
    if (e._cachedLabels.length) return e._cachedLabels;
    for (var i = this._logicalFormForControl(e).formElement, a = e.parentElement; a && a !== i; a = a.parentElement)
      if (this._isLabelElement(a)) {
        e._cachedLabels.push(a);
        break
      }
    return e._cachedLabels
  },
  _matchesForElement: function (e, n, t = !1) {
    var r = [],
      i = n.length;
    ...
    this._matchPatternAgainstElement(r, n, e);
    ...
    let p = placeholderInfoForElement(e);
    ...
    var f = e.getAttribute("aria-label");
    f && !e.isHiddenFromAccessibilityTree() && addMatchesFromText(f, ShouldStopAfterFirstMatch.StopAfterFirstMatch);
    var d = e.getAttribute("formcontrolname");
    d && d.length && addMatchesFromText(d, ShouldStopAfterFirstMatch.StopAfterFirstMatch);
    var m = this._pageScanContext,
      v = !0,
      y = !1;
    if (m && (m.shouldUsePageScan && (v = m.shouldUsePageScan()), m.reportPageScanUsedSuccessfully && (y = !0)), !v) return r;
    if (a) return y && m.reportPageScanUsedSuccessfully(!1), r;
    if (!0 === t) return r;
    var w, E = null,
      h = null;
    ...
    function betterMatchOfNewAndCurrentBestMatch(e, n) {
      return e && e.Match.length && (!n || !e.IsInCellAbove && n.IsInCellAbove || e.IsInCellAbove == n.IsInCellAbove && e.Distance < n.Distance) ? {
        FoundByPageScan: !0,
        Match: w.Match.toLowerCase(),
        Property: w.Property,
        Category: w.Category,
        ParentProperty: w.ParentProperty,
        Priority: M
      } : n
    }
    for (var M = 0; M < i; ++M) E = betterMatchOfNewAndCurrentBestMatch(w = this._matchFromPageScanBeforeElement(n[M], e), E), m && m.forwardScanIsFutile || (h = betterMatchOfNewAndCurrentBestMatch(w = this._matchFromPageScanAfterElement(n[M], e), h));
    var S = !1;
    if (E && (r.push(E), S = !0), h)
      for (var g = 0, F = r.length; g < F; ++g) {
        var b = r[g];
        if (h.Priority === b.Priority) {
          r.push(h), S = !0;
          break
        }
      }
    return y && m.reportPageScanUsedSuccessfully(S), r.length && p && p.AttributeMatchedWasValue && addMatchesFromText(p.Text, ShouldStopAfterFirstMatch.StopAfterFirstMatch), r
  },
  _bestMatchFromMatches: function (e, n, t) {
    function firstMatchOfMostFrequentlyOccurringStringFromMatches(e, n) {
      for (var t = e.length, r = {}, i = 0; i < t; ++i) {
        ...
        r[a] ? r[a].Frequency += 1 : r[a] = {
          Frequency: 1,
          FirstMatchObject: o
        }
      }
      var l = [];
      for (var s in r) l.push(r[s]);
      ...
      if (n === MatchCriteria.Property)
        for (i = 0; i < c; ++i) {
          if (p[i].FirstMatchObject.ParentProperty in r) return p[i].FirstMatchObject
        }
  ...
  _bestMatchForElement: function (e, n, t = !1) {
    if (!e) return null;
    var r = this._matchesForElement(e, n, t);
    return this._bestMatchFromMatches(r, e, n)
  },
  _labelForElementIfElementAndLabelAreOnlyElementsOfTheirKindAmongSiblingElements: function (e) {
    for (var n = null, t = e.tagName, r = siblingsIncludingSelfForElement(e), i = r.length, a = 0; a < i; ++a) {
      var o = r[a];
      if (e !== o) {
  ...
  _cachedPatternMatchers: function (e) {
    let n = "_" + e,
      t = this[n];
    return t || (this[n] = FormMetadataJSController[e], t = this[n]), t
  },
  _cachedElementPatternMatch: function (e, n, t) {
    var r = n + "_wasVisible",
      i = e[r];
    if (!0 === i) return e[n];
    var a = e.isVisible();
  ...
  _elementLooksLikeItHasAutocompleteList: function (e, n) {
    var t = e.getAttribute("autocomplete");
    if (n || t && "on" === t.toLowerCase()) return !1;
    let r = e.getAttribute("aria-autocomplete");
    return r && ("list" === r.toLowerCase() || "both" === r.toLowerCase())
  },
  ...
  _isSecureTextField: function (e) {
    ...
    const r = e._nextControlInLogicalForm;
  ...
  _looksLikeCreditCardNumberField: function (e, n) {
    ...
    if (n && -1 !== n.indexOf("cc-number")) return !0;
    let t = e.getAttribute("data-val-regex-pattern");
    if (t) {
      if (!new RegExp(t).test("12345")) return !1
    }
  ...
  _looksLikeMonthField: function (e, n) {
    ...
    if (12 === t || 13 === t)
      for (var r = [selectElementOptionsSequenceAnalysis(e, "text"), selectElementOptionsSequenceAnalysis(e, "value")], i = r.length, a = 0; a < i; a++) {
        var o = r[a],
  ...
  _looksLikeYearField: function (e, n) {
    ...
    var t = selectElementOptionsSequenceAnalysis(e, "text"),
      r = t.lengthOfLongestSequence,
      i = t.lastNumberInSequence;
    return r >= e.options.length - 3 && 1e3 < i && i < 3e3
  },
  _looksLikeOneTimeCodeField: function (e, n, t, r, i) {
    if (!this._isAutoFillableTextField(e) && !this._isAutoFillableSelectElement(e)) return !1;
    ...
    if (i) {
      ...
      if (a) {
        ...
        if (e) {
          ...
          t && this._matchPatternAgainstString(i, t.innerText) && n++
        }
      }
      if (n >= 2) return !0;
      const o = function (e) {
  ...
  _collectTextSample: function (e) {
    ...
    var n, t = "",
      r = e;
    do {
      n = (t = r.innerText.replace(/\s+/g, " ").trim()).length, r = r.parentElement
    } while (n < 300 && r);
    return n > 300 && (t = t.substr(0, 300)), t
  },
  ...
  _observedMaxLength: function (e) {
    ...
    let t;
    try {
      t = new RegExp(n.substr(1, n.length - 2))
    } catch (e) {
      return null
    }
    ...
    for (; i.length <= 20;) {
      let e = t.test(i);
      if (a && !e) return r;
      e && (a = !0, r = i.length), i += "b"
    }
    return null
  },
  _collectControlMetadata: function (e, n, t, r, i, a, o) {
    var l = {
    ...
    if (y && (l.AutocompleteTokens = y, -1 !== y.indexOf("username") ? l.ControlClaimsToBeUsernameViaAutocompleteAttribute = !0 : -1 !== y.indexOf("current-password") ? l.ControlClaimsToBeCurrentPasswordViaAutocompleteAttribute = !0 : -1 !== y.indexOf("new-password") && (l.ControlClaimsToBeNewPasswordViaAutocompleteAttribute = !0)), this._looksLikePasswordCredentialField(e) && (l.ControlLooksLikePasswordCredentialField = !0, "function" == typeof this._collectExtraControlMetadata && this._collectExtraControlMetadata(e, l), l.IsVisible && !t && (l.IsVisible = !isElementPositionedToBeEffectivelyInvisible(e))), l.ControlIsActiveElement || 1 !== n) {
      const n = this._collectSelectElementInfo(e);
      n && (l.SelectElementInfo = n);
      var w = placeholderInfoForElement(e);
      w && !w.AttributeMatchedWasValue && (l.ControlPlaceholder = w.Text), this._looksLikeIgnoredDataTypeField(e) ? l.ControlLooksLikeIgnoredDataTypeField = !0 : this._looksLikeCreditCardNumberField(e, y) ? l.ControlLooksLikeCreditCardNumberField = !0 : this._looksLikeCreditCardSecurityCodeField(e, y) ? l.ControlLooksLikeCreditCardSecurityCodeField = !0 : this._looksLikeCreditCardCardholderField(e, y) ? l.ControlLooksLikeCreditCardCardholderField = !0 : this._looksLikeCreditCardTypeField(e, y) ? l.ControlLooksLikeCreditCardTypeField = !0 : this._looksLikeMonthField(e, y) ? l.ControlLooksLikeMonthField = !0 : this._looksLikeYearField(e, y) ? l.ControlLooksLikeYearField = !0 : this._looksLikeDayField(e) ? l.ControlLooksLikeDayField = !0 : this._looksLikeCreditCardCompositeExpirationDateField(e, y) ? l.ControlLooksLikeCreditCardCompositeExpirationDateField = !0 : this._elementLooksLikeItHasAutocompleteList(e, y) && (l.ControlLooksLikeItHasAutocompleteList = !0)
    }
    if (l.ControlIsActiveElement || 2 === n || o) {
      let n = a && l.IsVisible;
      this._looksLikeOneTimeCodeField(e, y, r, i, n) && (l.ControlLooksLikeOneTimeCodeField = !0)
    }
    return 1 === n || l.ControlLooksLikeIgnoredDataTypeField || l.ControlIsSecureTextField || l.ControlLooksLikeCreditCardNumberField || l.ControlLooksLikeCreditCardSecurityCodeField || l.ControlLooksLikeCreditCardTypeField || l.ControlLooksLikeItHasAutocompleteList || (l.AddressBookLabel = this._addressBookLabelForElement(e)), l
  },
  _usesGeneratedPassword: function (e) {
    for (var n = !1, t = this._elementsWithGeneratedPasswords.length, r = 0; r < t; ++r) {
      var i = this._elementsWithGeneratedPasswords[r];
      if (e.containsControl(i)) {
        if (i.value !== this._generatedPasswords[r]) return !1;
        n = !0
      }
    }
    return n
  ...
  _collectSelectElementInfo: function (e) {
    ...
    for (var n = [], t = e.options, r = t.length, i = 0; i < r; ++i) {
      var a = t[i];
  ...
  _stringsToInspectForDeterminingFormType: function (e) {
    ...
    let a = queryElementBySelector(t, "legend");
    ...
    if (t.isVisible()) {
      let e = t.getBoundingClientRect(),
        r = !1;
      for (let i = 0, a = t; i <= 2 && a; ++i, a = a.parentElement) {
        let t = Array.prototype.slice.call(queryElementBySelector(a, "h1, h2, h3")),
          i = [
            [],
            [],
            []
        ...
        for (headerElement of t) {
          ...
          "H1" === e ? i[0].push(headerElement) : "H2" === e ? i[1].push(headerElement) : "H3" === e && i[2].push(headerElement)
        }
        let o = !0;
        for (headerElementsOfType of i) {
          ...
          e.left <= a.left && a.right <= e.right && a.distanceToRect(e) < 100 && (n.push(i.innerText), r = !0);
          break
        }
        if (o) break
      }
      if (!r) {
        ...
        if (1 === t.length) {
          ...
          e.left <= i.left && i.right <= e.right && i.distanceToRect(e) < 100 && n.push(r.innerText)
        }
      }
      for (let n = 0, r = t; n <= 2 && r; ++n, r = r.parentElement) {
        let n = Array.prototype.slice.call(queryElementBySelector(r, "button, input[type=submit]")).filter((function (n) {
          if (!n.isVisible()) return !1;
          let r = n.getBoundingClientRect();
          return r.top > e.bottom && !t.contains(n) && e.left <= r.left && r.right <= e.right && r.distanceToRect(e) < 100
        }));
        if (n.length) {
          l = n;
          break
    ...
    for (const e of c) {
      const t = e.type;
      "password" === t && (s = !0), "submit" !== t && "button" !== t || s && (e.isVisible() ? this._addInterestingStringsForButton(e, n) : p.push(e))
    }
    if (0 === n.length)
  ...
  _autoFillFormTypeOfTypesUsingKeywordMatching: function (e, n, t, r) {
    for (var i = n.length, a = [], o = 0; o < i; ++o) {
      var l = (0, mapOfFormTypeToProducerOfAssociatedKeywords[n[o]])();
      a.push(l)
    }
    var s = this._stringsToInspectForDeterminingFormType(e),
      p = this._keywordsIndicatingNonAutoFillableFormType;
    p || (p = FormMetadataJSController.keywordsIndicatingNonAutoFillableFormType, this._keywordsIndicatingNonAutoFillableFormType = p);
    var c = p.length,
      u = [];
    for (o = 0; o < i; ++o) u.push(0);
    if (r)
      for (const [e, t] of Object.entries(r)) u[n.indexOf(parseInt(e))] += t;
    for (var f = s.length, d = 0; d < f; ++d) {
      for (var m = s[d].toLowerCase(), v = 0; v < c; ++v)
        if (-1 !== m.indexOf(p[v])) return 2;
      for (o = 0; o < i; ++o) {
        l = a[o];
        for (var y in l) - 1 !== m.indexOf(y) && (u[o] += l[y])
      }
    }
    for (let t = 0; t < i; ++t) {
      const r = this._mapOfFormTypeToExtraScoreProducer[n[t]];
      u[t] += r(e)
    }
    for (o = 0; o < i; ++o) 0 !== u[o] && 0;
    var w = formActionAsAnchorElement(e.formElement, !0);
    if (w) {
      var E = w.pathname.toLowerCase() + w.search.toLowerCase();
      for (o = 0; o < i; ++o) {
        l = a[o];
        for (var y in l) - 1 !== E.indexOf(y) && (u[o] += l[y])
      }
    }
    var h = [],
      M = 0;
    for (o = 0; o < i; ++o) {
      var S = u[o];
      S > 0 && (S >= M ? (M = S, h.unshift(o)) : h.push(o))
    }
    if (1 === h.length) return n[h[0]];
    if (h.length > 1) {
      var g = h[0];
      if (u[g] > u[h[1]]) return n[g]
    }
    return t
  },
  ...
  _scoreForUsernameFieldCandidateFromLabelingAndPositionOfField: function (e, n, t) {
    return this._isLabeledUsernameField(e) ? n ? 4 : 6 : this._isLabeledEmailField(e) && !this._matchesNonEmailFieldLabelPattern(e) ? n ? 3 : 5 : t ? 2 : 1
  },
  _scoreForUsernameFieldCandidate: function (e, n, t) {
    var r = this._scoreForUsernameFieldCandidateFromLabelingAndPositionOfField(e, n, t);
    return e.isVisible() && (r += .5), this._matchesNonUsernameFieldLabelPattern(e) && (r -= 2), this._matchSearchFieldLabelPattern(e) && (r -= 1.5), e.readOnly && (r -= .5), e.id || e.name || (r -= 1), r
  },
  ...
  _collectRadioButtonInfo: function (e, n) {
    var t = e.radioButtonsWithName(n),
      r = t.length;
    ...
    function radioButtonInfoFromLabelElement(e) {
      ...
      let t = queryElementBySelector(e, "img"),
        r = t.length;
      for (let e = 0; e < r; ++e) addImageInfoToRadioButtonInfo(t[e], n);
      return n.length ? n : null
    }
    for (var i = !1, a = {}, o = 0; o < r; ++o) {
      a[(u = t[o]).value] = [u.value];
    ...
    if (i) return a;
    for (o = 0; o < r; ++o) {
      for (var u, f = "", d = (u = t[o]).traverseNextNode(); d && !this._isRenderedFormControl(d); d = d.traverseNextNode()) {
        var m = d.localName;
  ...
  _bestUsernameFieldCandidate: function (e, n, t) {
    var r = n.FormControls,
      i = r.filter((function (e) {
        return e.ControlClaimsToBeUsernameViaAutocompleteAttribute
      }));
    if (1 === i.length) return i[0];
    for (var a = 0, o = [], l = !1, s = r.indexOf(t), p = r.length, c = 0; c < p; ++c) {
      var u = r[c];
      if (u === t) {
        l = !0;
        continue
      ...
      if (n.IsVisible && !r[c].IsVisible && !u.ControlValue) continue;
      const i = 100;
      let m = e[c];
      if (!(m.value.length > i)) {
        var f = c + 1 < p && c + 1 === s,
    ...
    switch (m) {
      ...
      default:
        ...
        })), r[o.sort((function (e, n) {
          return y[e] - y[n]
        }))[0]]
    }
  },
  _autoFillFormTypeFromCandidateFormTypes: function (e, n, t) {
    switch (n.length) {
      case 1:
        return n[0];
      case 2:
        return this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [n[0], n[1]], t);
      default:
        return 1
    }
  },
  ...
  _identifyPasswordFieldIndices: function (e, n) {
    ...
    return this._bestMatchForElement(n[t - 1], this._oldPasswordPatternMatchers) ? {
  ...
  _isPasswordConfirmPair: function (e, n) {
    var t = this._matchesPasswordFieldLabelPattern(e),
      r = this._matchesConfirmPasswordFieldLabelPattern(n);
    return t && r
  },
  _trailingArgumentsForCollectControlMetadataFunction: function (e, n, t) {
    ...
    if (document.activeElement || 2 === n) {
      ...
      i = !!this._matchPatternAgainstString(e, documentTitleWithoutHostNamePrefix()), a = t && !!this._matchPatternAgainstString(e, t.pathname)
    }
    let o = !1;
  ...
  _collectFormMetadata: function (e, n) {
    ...
    if (s && s.href && (o.FormAction = s.href), 4 == n || 2 == n) {
      let e = selectorForElement(a);
    ...
    for (var L = p.length, T = 0; T < L; ++T) {
      ...
      const t = !I;
      var D = this._collectControlMetadata(A, n, u, f, d, m, t);
          ...
          if (!_ && D.ControlLooksLikeCreditCardSecurityCodeField && (_ = !0), C || !D.ControlLooksLikeCreditCardCardholderField && !D.ControlLooksLikeCreditCardNumberField) {
            if (!(D.ControlLooksLikeDayField || D.ControlLooksLikeMonthField || D.ControlLooksLikeYearField || D.ControlLooksLikeCreditCardCompositeExpirationDateField)) {
              if (D.ControlLooksLikePasswordCredentialField) {
                ...
                A.isHiddenFromAccessibilityTree() ? (h.push(A), M.push(D)) : (w.push(A), E.push(D))
              }
    ...
    } !w.length && h.length && (w = h, E = M);
    var O, N, q = this._identifyFormTypeAndPasswordFieldIndicesFromAutocompleteAttributes(w, E),
      B = q[0],
      z = q[1],
      V = q[2],
      j = z || this._identifyPasswordFieldIndices(E, w);
    if (void 0 !== j.PasswordFieldIndex && (S = E[j.PasswordFieldIndex], o.PasswordElementUniqueID = S.ControlUniqueID, g = this._explicitMaxLength(w[j.PasswordFieldIndex])), void 0 !== j.ConfirmationFieldIndex && (F = E[j.ConfirmationFieldIndex], o.ConfirmPasswordElementUniqueID = F.ControlUniqueID, b = this._explicitMaxLength(w[j.ConfirmationFieldIndex])), void 0 !== j.OldPasswordFieldIndex) {
      var R = E[j.OldPasswordFieldIndex];
      o.OldPasswordElementUniqueID = R.ControlUniqueID
    }
    if (S && (O = this._bestUsernameFieldCandidate(P, o, S)), O ? o.UsernameElementUniqueID = O.ControlUniqueID : N = this._findHiddenUsernameElement(e, o, P), B) o.AutoFillFormType = this._autoFillFormTypeFromCandidateFormTypes(e, B, B[0]);
      ...
      case 0:
        break;
      case 1:
        if (_ && o.UsernameElementUniqueID === o.FirstCreditCardCardholderFieldOrCreditCardNumberFieldUniqueID && E[0].ControlLooksLikeCreditCardNumberField) break;
        this._matchesConfirmPasswordFieldLabelPattern(w[0]) ? o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [4, 5], V || 3) : o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [4, 3], V || 3);
        break;
      case 2:
        ...
        break;
      case 3:
        g === b || !b || this._isPasswordConfirmPair(w[j.PasswordFieldIndex], w[j.ConfirmationFieldIndex]) ? o.AutoFillFormType = 5 : o.AutoFillFormType = 2;
        break;
      default:
        o.AutoFillFormType = 2
    } else if (2 === w.length || 3 === w.length) g !== b && b ? 2 === w.length ? this._isPasswordConfirmPair(w[0], w[1]) ? o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [4, 5], 2) : o.AutoFillFormType = 2 : this._isPasswordConfirmPair(w[j.PasswordFieldIndex], w[j.ConfirmationFieldIndex]) ? o.AutoFillFormType = 5 : o.AutoFillFormType = 2 : o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [4, 5], 5);
    else if (1 === w.length) {
      var W = w[0];
      if (this._matchesConfirmPasswordFieldLabelPattern(W, !0)) o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [3, 5], 5);
        ...
        if (this._isElementFollowedByForgotPasswordAffordance(W)) o.AutoFillFormType = 3;
        else {
          var H = [4, 3, 5];
          o.AutoFillFormType = this._autoFillFormTypeOfTypesUsingKeywordMatching(e, H, 2), 2 === o.AutoFillFormType && N && (o.AutoFillFormType = 4)
      ...
      for (T = 0; T < $; ++T) {
        A = P[T];
        var Y = o.FormControls[T],
          Z = Y.IsVisible;
        if (Z && Y.ControlIsTextField && K++, K > 1) break;
        var X = this._isLabeledEmailField(A);
        if (Z && (Y.ControlClaimsToBeUsernameViaAutocompleteAttribute || Y.ControlIsLabeledUsernameField || X || this._isLabeledLoginField(A)) && !this._matchesNonUsernameFieldLabelPattern(A) && !this._matchSearchFieldLabelPattern(A) && !A.readOnly && "INPUT" === A.tagName && !this._isLabeledSignUpField(A)) {
          let n = {};
          this._isElementFollowedByForgotEmailAffordance(A) && (n[3] = 2), 3 === this._autoFillFormTypeOfTypesUsingKeywordMatching(e, [4, 3], X ? 4 : 3, n) && (J = A, G = Y)
        }
        const n = Y.AutocompleteTokens;
        if (n) {
          const e = n.includes("username"),
            t = n.includes("webauthn"),
            r = e || X;
          (e && t || r) && (J = A, G = Y)
        }
      }
      1 === K && G && !controlAppearsToBePartOfPhotoTaggingInterface(J) && (o.AutoFillFormType = 3, o.UsernameElementUniqueID = G.ControlUniqueID)
    }
    4 === o.AutoFillFormType && o.FirstCreditCardCardholderFieldOrCreditCardNumberFieldUniqueID === o.UsernameElementUniqueID && (o.UsernameElementUniqueID = void 0), !o.UsernameElementUniqueID && N && this._extractMetadataForHiddenUsernameElement(N, o, P), 3 != o.AutoFillFormType && 4 != o.AutoFillFormType && 5 != o.AutoFillFormType && (o.UsernameElementUniqueID = void 0, o.OldPasswordElementUniqueID = void 0, o.PasswordElementUniqueID = void 0, o.ConfirmPasswordElementUniqueID = void 0), o.IsVisible || 3 == o.AutoFillFormType || 4 == o.AutoFillFormType || 5 == o.AutoFillFormType || (o.AutoFillFormType = 2), 1 !== n && (o.TextSample = this._collectTextSample(e._formElement)), o.FormIsEligibleForAutomaticLogin = this._formIsEligibleForAutomaticLogin(o, e.backingElement);
    ...
    var Q = FormMetadataJSController.shouldIncludeNonEmptyFields;
    if (o.IsVisible)
      for (T = ($ = P.length) - 1; T >= 0; --T) this._shouldIncludeControlMetadata(Q, o, P[T], o.FormControls[T]) || (4 !== n ? (o.FormControls.splice(T, 1), P.splice(T, 1)) : o.FormControls[T].WOULD_NORMALLY_NOT_BE_SENT_TO_UI_PROCESS = !0);
  ...
  _formIsEligibleForAutomaticLogin: function (e, n) {
    ...
    for (const n of e.FormControls) {
      ...
      if (r === e.UsernameElementUniqueID || r === e.PasswordElementUniqueID) continue;
      if (n.ControlIsDisabled) continue;
      if (n.ControlIsReadOnly) continue;
      if (!n.IsVisible) continue;
      const i = this.formControlWithUniqueID(r);
      if (!i) continue;
  ...
  _shouldIncludeControlMetadata: function (e, n, t, r) {
    if (t._relatesToCredentials) return !0;
    if (r.IsVisible) {
      if (formControlHasBeenClassifiedInAnInterestingWay(r)) return !0;
      if (e && r.ControlValue) return !0
    }
    return !(!n.UsernameElementUniqueID || r.ControlUniqueID !== n.UsernameElementUniqueID)
  },
  ...
  _findHiddenUsernameElement: function (e, n, t) {
    var r = e.formElement;
    if (!(r instanceof HTMLElement)) return;
    let i = queryElementBySelector(r, "input"),
      a = i.length;
    for (let e = 0; e < a; ++e) {
      let n = i[e];
      if (this._isElementAHiddenUsername(n)) return n
    }
    return null
  },
  _extractMetadataForHiddenUsernameElement: function (e, n, t) {
    var r = {
      ControlTagName: this._getTagName(e),
      ControlFieldName: this._getNameOrId(e),
      ControlUniqueID: this.controlUniqueID(e),
    ...
    n.UsernameElementUniqueID = r.ControlUniqueID, n.FormControls.push(r), t.push(e)
  },
  ...
  _cachedMetadataForLogicalForm: function (e) {
    for (var n = -1, t = 0; t < this._forms.length; ++t)
    ...
    return r.UsesGeneratedPassword = this._usesGeneratedPassword(e), r.Annotations = e.annotations, r
  },
  ...
  _markFormIsBestForStreamlinedLogin: function () {
    let e = this._indexOfFormWithHighestScoreIfGreaterThanZero((function (e, n) {
      ...
      if (!(t.right >= 0 && t.bottom >= 0 && t.left <= window.innerWidth && t.top <= window.innerHeight)) return 0;
      if (t.bottom + window.scrollY < 80) {
        let e = !(location.hash || location.pathname && "/" !== location.pathname || location.search),
          n = t.width / t.height;
        if (!e && n > 4) return 0
      }
      let r = 3 === e.AutoFillFormType,
        i = 0,
        a = e.FormControls,
        o = a.length;
      for (var l = 0; l < o; ++l) {
  ...
  _indexOfFormWithHighestScoreIfGreaterThanZero: function (e) {
    for (var n = null, t = null, r = this._formMetadata.length, i = 0; i < r; ++i) {
  ...
  _logicalFormWithID: function (e) {
    for (var n = this._forms, t = n.length, r = 0; r < t; ++r) {
      var i = n[r];
  ...
  _collectMetadata: function (e) {
    ...
    for (var t = n.length, r = 0; r < t; ++r) {
      ...
      let t = this._collectFormMetadata(n[r], e);
      2 === e && "function" == typeof evaluateCustomJavaScript && (t.ResultFromEvaluatingCustomJavaScript = evaluateCustomJavaScript(n[r], t)), this._formMetadata.push(t)
    }
  ...
  _collectAndCacheFormMetadata: function (e, n) {
    for (var t = this._collectFormMetadata(e, n), r = -1, i = this._forms.length, a = 0; a < i; ++a)
      if (this._forms[a].formUniqueID === e.formUniqueID) {
        r = a;
        break
      }
    return -1 === r ? (this._forms.push(e), this._formMetadata.push(t)) : this._formMetadata[r] = t, t
  },
  ...
  _fillControlWithGeneratedPassword: function (e, n) {
    var t = this._elementsWithGeneratedPasswords.indexOf(e); - 1 === t && (this._elementsWithGeneratedPasswords.push(e), t = this._elementsWithGeneratedPasswords.length - 1), this._generatedPasswords[t] = n, this._autoFillControlWithValue(e, n, !0)
  },
  fillFormWithPassword: function (e, n, t) {
    var r = this._metadataForFormWithID(e);
    if (null === r) return null;
    const i = r.PasswordElementUniqueID,
    ...
    let p = r.ConfirmPasswordElementUniqueID;
    p || 5 !== r.AutoFillFormType && 4 !== r.AutoFillFormType || (p = (r = this._recollectMetadataForFormWithID(e) || r).ConfirmPasswordElementUniqueID);
  ...
  fillFieldWithGeneratedPassword: function (e, n) {
    ...
    t && this._isTextField(t) && this._fillControlWithGeneratedPassword(t, n)
  },
  ...
  _clearFormField: function (e) {
    if (e)
      if (this._isSelectElement(e)) e.selectedIndex = 0;
        ...
        let n = this._logicalFormForControl(e).radioButtonsWithName(e.name),
          t = n.length;
        for (let e = 0; e < t; ++e) n[e].checked = !1
    ...
    if (null !== n) {
      var t = function uniqueControlIDToFocus(e) {
        for (const n of e.FormControls) {
          ...
          if (t === e.UsernameElementUniqueID || t === e.PasswordElementUniqueID || n.ControlLooksLikeOneTimeCodeField) return t
        }
      }(n);
      if (t) this.formControlWithUniqueID(t).focus()
    }
  },
  ...
  _getOrCreateCachedMetadataForLogicalForm: function (e, n) {
    ...
    return !t || null != n && 1 === t.RequestType && 1 !== n ? this._collectAndCacheFormMetadata(e, n) : t
  },
  _getOrCreateLogicalFormForTextFieldOrSelectElement: function (e) {
    var n = this._indexInCacheOfLogicalFormContainingControl(e);
    if (-1 === n) n = this._forms.length;
    else
      for (var t = this._formMetadata[n].FormControls, r = t.length, i = e._controlUniqueID, a = 0; a < r; ++a)
        if (t[a].ControlUniqueID === i) return this._forms[n]; var o = this._logicalFormsInPage(),
          l = o.length;
    for (a = 0; a < l; ++a) {
      var s = o[a];
  ...
  _cachedMetadataForFormWithTextFieldOrSelectElement: function (e, n) {
    ...
    return t ? this._getOrCreateCachedMetadataForLogicalForm(t, n) : null
  },
  ...
  _updateAnnotationsForField: function (e) {
    ...
    if (n) {
      var t = this._getOrCreateCachedMetadataForLogicalForm(n);
      if (t) {
        var r = e._controlUniqueID;
        this._isCurrentPasswordElementUniqueID(t, r) ? n.annotate({
          CurrentPassword: e.value
        }) : this._isNewPasswordElementUniqueID(t, r) ? n.annotate({
          NewPassword: e.value
        }) : t.UsernameElementUniqueID === r && n.annotate({
          Username: e.value
        }), isCredentialElementUniqueID(t, r) && (e._relatesToCredentials = "" !== e.value)
      }
    }
  },
  ...
  textFieldOrSelectElementMetadata: function (e, n) {
    ...
    var t = [null, null],
      r = this._cachedMetadataForFormWithTextFieldOrSelectElement(e, n);
    if (!r) return t;
    this._pageScanContext = {
      backwardScanCache: new WeakMap,
      forwardScanCache: new WeakMap
    };
    let i = this._logicalFormWithID(r.FormID),
    ...
    return delete this._pageScanContext, c.ControlLooksLikeOneTimeCodeField && this._oneTimeCodeIsEligibleForAutomaticLogin(c, r) && (c.OneTimeCodeIsEligibleForAutomaticLogin = !0), c.SelectionStart = e.selectionStart, c.SelectionLength = e.selectionEnd - e.selectionStart, 3 === n && (!r.UsernameElementUniqueID && this._isAnyPasswordElementUniqueID(r, c.ControlUniqueID) && i.isAnnotated && i.annotate({
      Username: null
    }), this._updateAnnotationsForField(e)), t[0] = c, t[1] = r, t
  },
  ...
  setFormFieldSelection: function (e, n, t) {
    var r = this.formControlWithUniqueID(e);
    r && this._isTextField(r) && (r.selectionStart = n, r.selectionEnd = n + t)
  },
  replaceFormFieldRangeAndSelectTail: function (e, n, t, r, i) {
    var a = this.formControlWithUniqueID(e);
    if (a && this._isTextField(a)) {
      var o = a.value,
        l = o.substr(0, n) + r + o.substr(n + t);
  ...
  _collectVisibleNonEmptyTextFieldsAndTextAreasInForm: function (e, n, t) {
    visibilityCacheGeneration++;
    for (var r = e.elements, i = r.length, a = 0; a < i; ++a) {
      var o = r[a];
      o.isVisible() && (null != o.value && o.value.length && (this._isTextField(o) ? n.push(o) : this._isTextArea(o) && t.push(o)))
    }
  },
  visibleNonEmptyFormTextControls: function () {
    ...
    for (let r = 0; r < t.length; ++r) this._collectVisibleNonEmptyTextFieldsAndTextAreasInForm(t[r], e, n);
    return [e, n]
  },
  visibleNonEmptyFormTextControlsInForm: function (e) {
    var n = [],
      t = [];
    return this._collectVisibleNonEmptyTextFieldsAndTextAreasInForm(e, n, t), [n, t]
  },
  _autoFillRadioButton: function (e, n, t) {
    for (var r = this._logicalFormForControl(e).radioButtonsWithName(e.name), i = r.length, a = 0; a < i; ++a) {
      var o = r[a];
      if (o.value === n) return o.dispatchEvent(eventThatBubbles("click")), o.checked = !0, void FormMetadataJSController.setInputElementAutofilled(o, t)
    }
  },
  _autoFillControlWithValueAndOptions: function (e, n, t, r, i) {
    if (isRadioButtonElement(e)) this._autoFillRadioButton(e, n, r);
    else if (this._isSelectElement(e)) this._autoFillSelectWithOptionIndex(e, n, r);
    else {
      t == ShouldFocusAndBlur.Yes && e.dispatchEvent(new Event("focus")), e.value = "";
      for (var a = 0; a < n.length; a++) e.dispatchEvent(eventThatBubbles("keydown")), e.dispatchEvent(eventThatBubbles("keypress")), e.value = e.value + n[a], e.dispatchEvent(eventThatBubbles("textInput")), e.dispatchEvent(eventThatBubbles("keyup"));
      e.dispatchEvent(eventThatBubbles("change")), this._updateAnnotationsForField(e), t == ShouldFocusAndBlur.Yes && e.dispatchEvent(new Event("blur")), i ? FormMetadataJSController.setInputElementAutofilledAndObscured(e, n.length && r) : FormMetadataJSController.setInputElementAutofilled(e, n.length && r)
    }
  },
  _autoFillControlWithValue: function (e, n, t, r) {
    this._autoFillControlWithValueAndOptions(e, n, ShouldFocusAndBlur.Yes, t, r)
  },
  _autoFillSelectWithOptionIndex: function (e, n, t) {
    ...
    var r = e.split(""),
      ...
      a = function (e) {
        if (e >= i) FormMetadataJSController.finishedAutoFillingOneTimeCode(n);
          ...
          var t = document.activeElement,
            o = t.value + r[e];
          this._autoFillControlWithValueAndOptions(t, o, ShouldFocusAndBlur.No, !0, !1), setTimeout(a, 0, e + 1)
        }
      }.bind(this);
    a(0)
  },
  ...
  autoFillControlsByID: function (e, n, t, r, i, a) {
    ...
    if (n) {
      ...
      this._synchronouslyAutoFillControls(c, t, p)
    } else this._asynchronouslyAutoFillControls(e, s, t, a, p)
  },
  _synchronouslyAutoFillControls: function (e, n, t) {
  ...
  _asynchronouslyAutoFillControls: function (e, n, t, r, i) {
    var a = n.elements,
      o = a.length,
      l = function (n) {
        if (n >= o) i();
          ...
          if (void 0 !== p) {
            let e = r.some((e => s._controlUniqueID.includes(e)));
            this._autoFillControlWithValue(s, p, t, e)
          }
          setTimeout(l, 0, n + 1)
        }
      }.bind(this);
  ...
  _isInputAllowedInSearchForm: function (e, n) {
    ...
    if ("select" === t) return !n || isSelectInDefaultState(e);
    if ("input" !== t) return !1;
    var r = e.type;
    return "radio" === r || "checkbox" === r ? !n || isCheckboxOrRadioButtonInDefaultState(e) : "hidden" === r || "reset" === r || "submit" === r || "button" === r || this._isTextField(e) && !this._isSecureTextField(e)
  },
  _isSearchForm: function (e, n) {
    if ("get" !== e.method) return !1;
    for (var t = e.elements, r = t.length, i = 0; i < r; ++i)
      if (!this._isInputAllowedInSearchForm(t[i], n)) return !1;
    return !0
  },
  _shouldInputBeIncludedInSearchURLQuery: function (e) {
    ...
    var n = this._getTagName(e).toLowerCase(),
      t = e.type;
    return "button" === n ? "submit" === t : "input" === n && ("submit" === t || ("checkbox" === t || "radio" === t ? e.checked : "hidden" === t || this._isTextField(e)))
  },
  ...
  _setQueryString: function (e, n) {
    ...
    return t.href = e, t.search = n, t.href
  },
  searchTextFieldFormSubmissionURLString: function (e, n) {
    ...
    var t = e.form;
    if (!t) return null;
    var r = t.getAttribute("action");
    if (!r || !r.length) return null;
    if (!/^https?:/i.test(t.action)) return null;
    if (!this._isSearchForm(t, n)) return null;
    for (var i = null, a = "", o = t.elements, l = o.length, s = 0; s < l; ++s) {
      var p = o[s];
    ...
    return this._setQueryString(t.action, a)
  }
};
...
function domainsForDisplayFromUsernamesAndDomains(e, n) {
  const t = e.length;
  let r = n.map((function (e) {
    return e.replace(/^(www|m)\./, "")
  })),
    i = [];
  for (var a = 0; a < t; a++) i.push([e[a], r[a]]);
  for (a = 0; a < t; a++) {
    let e = [];
    for (var o = a + 1; o < t; o++) i[a].join("\n") === i[o].join("\n") && (e.length || e.push(a), e.push(o));
    for (identicalIndex of e) r[identicalIndex] = n[identicalIndex]
  }
  return r
}
class Localizer {
  static configureDocumentElementForLanguage(e, n) {
    switch (n) {
      case "he":
      case "ar":
      case "fa":
        e.setAttribute("dir", "rtl"), e.setAttribute("lang", n)
    }
  }
  constructor(e) { }
  getMessage(e, n, t) {
    const r = this.messageNamesToTry(e);
    for (let e of r) {
      let r;
      try {
        r = chrome.i18n.getMessage(e, n, t)
      } catch {
        r = chrome.i18n.getMessage(e, n)
      }
      if (r) return r
    }
    return ""
...
class ExtensionSettings {
  ...
  set allowExtensionToControlAutoFillSettings(e) {
    this.#t = e, this.#o().then(this.#a.bind(this))
  }
  #o() {
  ...
  clearControlOfBrowserAutoFillSettings() {
    return this.#e ? Promise.reject(new Error("This Settings instance does not allow writing browser settings")) : Promise.allSettled([this.#p(chrome.privacy.services.passwordSavingEnabled), this.#p(chrome.privacy.services.autofillCreditCardEnabled), this.#p(chrome.privacy.services.autofillAddressEnabled)]).then((e => (this.#s(), e)))
  }
  #r() {
    let e = new Promise((e => {
      chrome.storage.sync.get({
        ...
        this.#n = n.enableInPageAutoFill, this.#t = n.allowExtensionToControlAutoFillSettings, e()
      }))
    }));
  ...
  #l(e, n) {
    return this.#c(e).then((t => t ? t.value === n ? {
      details: t,
      newValue: n
    } : new Promise(((r, i) => {
      e.set({
        ...
        chrome.runtime.lastError && (chrome.runtime.lastError, chrome.runtime.lastError, i(chrome.runtime.lastError)), r({
          details: t,
          newValue: n
        })
      }))
  ...
  #c(e) {
    return new Promise((n => {
      e || n({}), e.get({}, (e => {
        "not_controllable" === e.levelOfControl && reject(new Error("Cannot control this setting")), n(e)
      }))
    }))
  }
  #p(e) {
...
function fillControlsByID(e, n) {
  let t = n ? FormMetadataJS.formControlWithUniqueID(n) : null;
...
function fillLoginIntoForm(e, n, t, r, i, a) {
...
function detectPresetUserName(e, n, t) {
  e.FormControls.forEach((function (n, t, r) {
...
function mydump(e, n) {
  var t = "";
  n || (n = 0);
  for (var r = "", i = 0; i < n + 1; i++) r += "    ";
  if ("object" == typeof e)
    for (var a in e) {
      var o = e[a];
      "object" == typeof o ? (t += r + "'" + a + "' ,", t += mydump(o, n + 1)) : t += r + "'" + a + "'\"" + o + '",'
    } else t = e + "(" + typeof e + ")";
  return t
}

function assignFieldsForMetadataAndPurpose(e, n, t, r) {
  const i = e.AutoFillFormType;
  switch (n === ForPageWideFill && humanReadableFormType(g_formTypeOfFormBestForPageWideAutoFill = i), i) {
    case 0:
    case 1:
    case 2:
      for (const t of e.FormControls)
        if (t.ControlIsActiveElement) {
          if (t.ControlIsLabeledUsernameField) {
            g_usernameControls[n] = FormMetadataJS.formControlWithUniqueID(t.ControlUniqueID), g_usernameElementUniqueIDs[n] = t.ControlUniqueID;
            break
          }
          if (t.ControlIsSecureTextField) {
            g_passwordControls[n] = FormMetadataJS.formControlWithUniqueID(t.ControlUniqueID), g_passwordElementUniqueIDs[n] = t.ControlUniqueID, n === ForPageWideFill && (g_formTypeOfFormBestForPageWideAutoFill = 3);
            break
          }
        }
      break;
...
function runFormMetadataHeuristics(e, n) {
  ...
  g_formTypeOfFormBestForPageWideAutoFill = 0;
  let r = FormMetadataJS.formsAndMetadata(1);
  if (r) {
    r[0];
    r[1].forEach(((t, r, i) => {
      t && t.FormIsBestForPageLevelAutoFill && assignFieldsForMetadataAndPurpose(t, ForPageWideFill, e, n)
    }))
...
function showCompletionList(e, n, t) {
  ...
  g_completionListContainer.style.setProperty("top", l, "important"), g_completionListContainer.style.setProperty("left", s, "important"), g_completionListContainer.attachShadow({
    ...
    let n = e.getBoundingClientRect(),
      t = Math.round(n.y + n.height) + i + "px",
      r = Math.round(n.x) + "px";
    t === l && r === s || (g_dateOfCompletionListAnchoringFieldFocusOrMovementOfThatField = new Date, g_completionListContainer.style.setProperty("top", t, "important"), g_completionListContainer.style.setProperty("left", r, "important"), l = t, s = r)
  }), 100)
}

function shouldOfferCompletionListForField(e, n, t) {
  return !(g_lastFilledField === e && Date.now() - g_dateOfLastAutoFill < 100) && (("password" !== e.type || !e.value.length) && (!!n.ControlLooksLikePasswordCredentialField || (!!n.ControlClaimsToBeUsernameViaAutocompleteAttribute || (n.ControlLooksLikeOneTimeCodeField ? !e.value.length : !(!t.UsernameElementUniqueID || t.UsernameElementUniqueID !== n.ControlUniqueID) || (!(!t.PasswordElementUniqueID || t.PasswordElementUniqueID !== n.ControlUniqueID) || (!!n.ControlIsLabeledUsernameField || (e === g_usernameControls.ForCompletionList || e === g_passwordControls.ForCompletionList)))))))
}
...
function elementWasFocused(e) {
  ...
  let [n, t] = FormMetadataJS.textFieldOrSelectElementMetadata(e, 0);
  shouldOfferCompletionListForField(e, n, t) && showCompletionList(e, n, t)
}
...
chrome.runtime.onMessage.addListener(((e, n, t) => {
  switch (e.from, e.tabId, e.frameId, e.subject) {
    ...
    case "getTextFieldAndFormMetadataOfActiveTextFieldAndPresetUserNameAndHostname":
      {
        ...
        let [n, r] = FormMetadataJS.textFieldOrSelectElementMetadata(g_focusedControl, 0);
        t({
          textFieldMetadata: n,
          formMetadata: r,
    ...
    case "fillOneTimeCodeIntoForm":
      let n = e.oneTimeCode;
      if ("totp" === n.source) g_completionListAnchoringFieldBeforeOneTimeCodeRefresh = g_completionListAnchoringField || g_completionListAnchoringFieldPriorToBlur, g_oneTimeCodeToFillAfterUpdate = n;
      chrome.runtime.sendMessage({
        from: "content",
    ...
    case "fillCurrentTOTPCodeIntoForm":
      const r = e.oneTimeCodes;
      if (!r || !g_oneTimeCodeToFillAfterUpdate) {
        clearOneTimeCodeState();
        break
      }
      const i = r.find((e => "totp" === e.source && e.username === g_oneTimeCodeToFillAfterUpdate.username && e.domain === g_oneTimeCodeToFillAfterUpdate.domain));
      if (!i) {
        clearOneTimeCodeState();
        break
      }
    ...
    case "getTextFieldAndFormMetadataOfActiveTextField":
      ...
      break;
    case "getPageType":
      e.tabId, e.frameId, e.tabId, e.frameId, e.tabId, e.frameId, runFormMetadataHeuristics(e.tabId, e.frameId), t(g_formTypeOfFormBestForPageWideAutoFill);
      break;
  ...
  if (!isCompletionListVisible()) {
    let [t, r] = FormMetadataJS.textFieldOrSelectElementMetadata(n, 0);
    return void ("ArrowDown" === e.key && shouldOfferCompletionListForField(n, t, r) && showCompletionList(e.target, t, r))
  }
  let t = {};
  switch (e.key) {
    case "Escape":
  ...
  let [t, r] = FormMetadataJS.textFieldOrSelectElementMetadata(n, 3), i = n.value;
  t.ControlLooksLikePasswordCredentialField || t.ControlLooksLikeOneTimeCodeField ? i.length && hideCompletionListIfNecessary() : isCompletionListVisible() || !shouldOfferCompletionListForField(n, t, r) ? n === g_completionListAnchoringField && isCompletionListVisible() && chrome.runtime.sendMessage({
    from: "content",
    subject: "typedUserNameChanged",
    username: i
  }) : showCompletionList(n, t, r)
